defmodule Converter do
  ...
  defp from_meters(val) do
    val * 3.335638620368e-9
  end

  defp from_miles(val) do
    val * 5.36819e-6
  end

  defp from_feet(val) do
    val * 1.016702651488166404e-9
  end

  defp from_inches(val) do
    val * 8.472522095734715723e-11
  end
